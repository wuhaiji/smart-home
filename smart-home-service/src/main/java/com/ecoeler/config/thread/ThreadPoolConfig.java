package com.ecoeler.config.thread;
...
public class ThreadPoolConfig {
    ...
    private static class CustomThreadFactory implements ThreadFactory {
        ...
        CustomThreadFactory() {
            ...
            //初始化线程名称
            namePrefix = "async-pool-" + poolNumber.getAndIncrement();
        }
