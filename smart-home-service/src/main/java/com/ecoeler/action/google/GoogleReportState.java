...
final class GoogleReportState {
    ...
    public static void makeRequest(
        ...
        HomeGraphApiServiceProto.ReportStateAndNotificationResponse reportStateAndNotificationResponse = actionsApp.reportState(request);
        LOGGER.info("report states response:"+reportStateAndNotificationResponse.toString());
