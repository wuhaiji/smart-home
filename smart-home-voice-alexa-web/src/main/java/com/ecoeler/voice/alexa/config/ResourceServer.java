package com.ecoeler.voice.alexa.config;
...
public class ResourceServer extends ResourceServerConfigurerAdapter {
    ...
    public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
        ...
        service.setCheckTokenEndpointUrl(resourceProperties.getCheckTokenUrl());
        service.setClientId(resourceProperties.getClientId());
        service.setClientSecret(resourceProperties.getClientSecret());
